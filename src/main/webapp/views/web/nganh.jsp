                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						<div
							...
							<h6 class="m-0 font-weight-bold text-primary">DANH SÁCH NGÀNH</h6>
							<a href="nganh-them"
									...
									<tbody>
										...
										<c:forEach var="data" items="${list}">
											<tr>
												...
												<td><c:out value='${data.ma_nganh}' /></td>
												<td><c:out value='${data.ten_nganh}' /></td>
												<td><c:out value='${data.loai_nganh}' /></td>
												<td>
												<a href="truong-edit?id=<c:out value='${data.ma_nganh}' />"
													type="button" class="btn btn-warning">Sửa</a> 
												<a href="truong-delete?id=<c:out value='${data.ma_nganh}' />"
