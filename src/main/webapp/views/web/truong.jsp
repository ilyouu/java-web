                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						<div
							...
							<h6 class="m-0 font-weight-bold text-primary">DANH SÁCH TRƯỜNG</h6>
							<a href="truong-them"
								class="btn btn-primary btn-user">Thêm</a>
						</div>
						<div class="card-body">
									...
									<tbody>
										...
										<c:forEach var="data" items="${list}">
											<tr>
												...
												<td><c:out value='${data.ma_truong}' /></td>
												<td><c:out value='${data.ten_truong}' /></td>
												<td><c:out value='${data.dia_chi}' /></td>
												<td><c:out value='${data.so_dien_thoai}' /></td>
												<td>
												<a href="truong-edit?id=<c:out value='${data.ma_truong}' />"
													type="button" class="btn btn-warning">Sửa</a> 
												<a href="truong-delete?id=<c:out value='${data.ma_truong}' />"
